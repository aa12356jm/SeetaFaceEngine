...
int main(int argc, char** argv) {
 /* if (argc < 3) {
  ...
  seeta::FaceDetection detector(argv[2]);*/
	////////检测器初始化////////////
	const char* img_path = "E:\\WorkSpace_home\\partTime_projects\\SeetaFaceEngine\\Detection\\Detection\\0.jpg";
	const char* model_path = "E:\\WorkSpace_home\\partTime_projects\\SeetaFaceEngine\\FaceDetection\\model\\seeta_fd_frontal_v1.0.bin";
